...
if __name__ == "__main__":
    ...
    inferred_trial = run_ll(infile="lunarlander_expert_rewards.txt", reward_type="inferred", epsilon_start=0.9, num_episodes=500)
    print(inferred_trial)
    exit()
    ...
    reward_files = [
        "./lunarlander_experiments/lunarlander_expert_rewards1.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards2.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards3.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards4.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards5.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards6.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards7.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards8.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards9.txt",
        "./lunarlander_experiments/lunarlander_expert_rewards10.txt",
    ]
