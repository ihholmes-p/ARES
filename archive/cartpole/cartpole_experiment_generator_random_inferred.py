...
if __name__ == "__main__":
    ...
    reward_files = [
        "cartpole_random_rewards1.txt",
        "cartpole_random_rewards2.txt",
        "cartpole_random_rewards3.txt",
        "cartpole_random_rewards4.txt",
        "cartpole_random_rewards5.txt",
        "cartpole_random_rewards6.txt",
        "cartpole_random_rewards7.txt",
        "cartpole_random_rewards8.txt",
        "cartpole_random_rewards9.txt",
        "cartpole_random_rewards10.txt",
    ]
    ...
    with open("cartpole_experiment_results_random_new_inferred1.txt", 'w') as file:
