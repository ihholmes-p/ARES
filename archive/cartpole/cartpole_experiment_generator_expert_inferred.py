...
if __name__ == "__main__":
    ...
    reward_files = [
        "cartpole_expert_new_rewards1.txt",
        "cartpole_expert_new_rewards2.txt",
        "cartpole_expert_new_rewards3.txt",
        "cartpole_expert_new_rewards4.txt",
        "cartpole_expert_new_rewards5.txt",
        "cartpole_expert_new_rewards6.txt",
        "cartpole_expert_new_rewards7.txt",
        "cartpole_expert_new_rewards8.txt",
        "cartpole_expert_new_rewards9.txt",
        "cartpole_expert_new_rewards10.txt",
    ]
    ...
    with open("cartpole_experiment_results_expert_new_inferred1.txt", 'w') as file:
